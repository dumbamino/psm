...
class _CompleteTalqinScreenState extends State<CompleteTalqinScreen> with TickerProviderStateMixin {
  // --- Configuration ---
  ...
  void initState() {
    ...
    _transformationControllers = List.generate(talqinPages.length, (_) => TransformationController());
    ...
    return AnimatedOpacity(
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Text(
            "Page ${_currentPage + 1} of ${talqinPages.length}",
